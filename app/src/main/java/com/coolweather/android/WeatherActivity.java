        ...
        public void onReceiveLocation(final BDLocation location) {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    currentPosition.append("当前位置：").append("\n");
...
//                    }
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=83b78065a05b4ffdad71abf4f54f4895";
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        String updateTime ="天气更新时间"+ weather.basic.update.updateTime.split(" ")[1];
